...
detector = NDDDetector(coverage.similarity_models, declared_clustering, detected_clustering)
print("Clustering NDDs...")
NDD_clustering = detector.clustering_ndd(outputname)
print("Saving NDDs...")
detector.save(outputname)
print("NDDs saved.")
